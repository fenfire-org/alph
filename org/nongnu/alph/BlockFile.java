...
/** A (possibly) temporary file providing some media.
 * Used by ImageSpan and PageImageScroll to provide pages.
 */
public interface BlockFile {
     ...
     */
    String getFilename();
    /** This file will not be used any more and may be deleted.
     */
    void close();
}
